...
// Страница CookiesInfo предоставляет пользователю подробную информацию об использовании файлов cookie на сайте. 
// Она объясняет:что такое файлы cookie,как пользователь может управлять настройками cookie.
// Страница статическая, не содержит интерактивных элементов, кроме ссылки для возврата на главную страницу. 
// Она связана с баннером CookieConsent: ссылки на эту страницу размещены в баннере и в футере, чтобы пользователь мог ознакомиться с пользовательским соглашением.
// Контент носит учебный/демонстрационный характер.
